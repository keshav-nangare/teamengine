    ...
    <div id="testMethodsByStatus">
      ...
      <table width="100%" class="testMethodsTable" cellpadding="0" cellspacing="0">
        <tr class="methodsTableHeader">
          <td style="vertical-align:top;width=20%;">Name</td>
          <td style="vertical-align:top;width=20%;">Description</td>
          <td nowrap="true" style="vertical-align:top;width=20%;">Started</td>
          <td nowrap="true" style="vertical-align:top;width=20%;">Duration</td>
          <td style="vertical-align:top;width=20%;">Reason For Test Fail</td>
        </tr>
  ...
  <xsl:template name="testMethodsList">
    ...
    <xsl:for-each select="$methodList">
      ...
      <tr id="{concat($methodId, '_row')}" class="{testng:testMethodStatus(.)}">
        ...
        <td class="firstMethodCell" style="vertical-align:top">
